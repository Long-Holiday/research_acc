...
def perform_deduplication(target_date=None):
    ...
    if target_date is None:
        ...
        try:
            ...
            print(f"Invalid date format: {target_date}. Expected YYYY-MM-DD", file=sys.stderr)
            return "error"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Check Scrapy crawling stats and perform deduplication.")
    parser.add_argument("--date", help="Target date in YYYY-MM-DD format (defaults to system local today)")
